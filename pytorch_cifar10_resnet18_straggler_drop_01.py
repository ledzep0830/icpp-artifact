    ...
    with tqdm(total=len(train_loader),
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            for i in range(0, len(data), args.batch_size):
                ...
                loss.mul_(math.ceil(float(hvd.size()) / float(hvd.size()-num_straggler)))
                ...
                if hvd.rank() == 1 and iteration_num_per_worker < 10:
                ...
                if iteration_num_per_worker > 5 and is_straggler == 0:
                    if computation_time > threshold_this_epoch:
                        ...
                        if warning_counter == 5:
                            ...
                            straggler_cmd = 'python3 pytorch_cifar10_resnet20_proposed_straggler.py --rank {} --sleep-time {} --resume-from-epoch {} --total-iteration-num {}'.format(
...
if __name__ == '__main__':
    ...
    # PROPOSED: broadcast parameters & optimizer state every epoch
